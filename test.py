...
obama_image = face_recognition.load_image_file("template.jpeg")
...
# image = face_recognition.load_image_file("tocheck.jpeg")
...
#             img1_path = "people/joey/joey.jpeg",
#             img2_path = "tocheck.jpeg",
#             model_name = models[2])
...
# # DeepFace.stream(db_path = "people", model_name = models[2])